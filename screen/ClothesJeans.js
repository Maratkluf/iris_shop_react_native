...
export default function ClothesJeans(props) {

  const [Clothes, setClothes] = useState([])

  useEffect(() => {
    firebase.db.collection('Clothes').where('product', '==', 'Джинсы').onSnapshot(querySnapshot => {
      const Clothes = [];
  ...
  sortAsc = () => {   
    firebase.db.collection('Clothes').orderBy('price', 'asc').where('product', '==', 'Джинсы').onSnapshot(querySnapshot => {
      const Clothes = [];
  ...
  sortDesc = () => {   
      firebase.db.collection('Clothes').orderBy('price', 'desc').where('product', '==', 'Джинсы').onSnapshot(querySnapshot => {
        const Clothes = [];
