...
export default function ClothesBottom(props) {

  const [Clothes, setClothes] = useState([])

  useEffect(() => {
    firebase.db.collection('Clothes').where('product', '==', 'Брюки').onSnapshot(querySnapshot => {
      const Clothes = [];
  ...
  sortAsc = () => {   
    firebase.db.collection('Clothes').orderBy('price', 'asc').where('product', '==', 'Брюки').onSnapshot(querySnapshot => {
      const Clothes = [];
  ...
  sortDesc = () => {   
      firebase.db.collection('Clothes').orderBy('price', 'desc').where('product', '==', 'Брюки').onSnapshot(querySnapshot => {
        const Clothes = [];
