...
export default function ClothesUp(props) {

  const [Clothes, setClothes] = useState([])

  useEffect(() => {
    firebase.db.collection('Clothes').where('forFilter', '==', 'Up').onSnapshot(querySnapshot => {
      const Clothes = [];
  ...
  sortAsc = () => {   
    firebase.db.collection('Clothes').orderBy('price', 'asc').where('forFilter', '==', 'Up').onSnapshot(querySnapshot => {
      const Clothes = [];
  ...
  sortDesc = () => {   
      firebase.db.collection('Clothes').orderBy('price', 'desc').where('forFilter', '==', 'Up').onSnapshot(querySnapshot => {
        const Clothes = [];
